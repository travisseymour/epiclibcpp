...
typedef std::map<Compiler_node_data_pair, Counter, std::less<Compiler_node_data_pair>>
    Compiler_node_data_pair_counter_map_t;
...
{
    bool make_valid_pair(const Compiler_node_data& first, const Compiler_node_data& second,
    ...
    Compiler_node_data make_new_node_data_for_pair(const Compiler_node_data_pair& node_data_pair)
    {
        Combining_Node* new_node_ptr = new Simple_And_Node(
            Combining_Node::get_next_node_number(), node_data_pair.first.node_ptr, node_data_pair.second.node_ptr);
...
struct Bindings_Simple_And_Node_pair
{
    ...
    Compiler_node_data make_new_node_data_for_pair(const Compiler_node_data_pair& node_data_pair)
    {
        ...
        Combining_Node* new_node_ptr = new Simple_Bindings_And_Node(
            Combining_Node::get_next_node_number(), node_data_pair.second.node_ptr, node_data_pair.first.node_ptr);
...
template <class PT>
void find_most_frequent_pair(PT pair_type, const Compiler_rule_data_list_t& rule_data_list,
                             Compiler_node_data_pair& max_pair, int& max_count)
{
...
template <class PT>
void generate_pairs(PT pair_type, const Compiler_node_data_list_t& node_data_list,
                    Compiler_node_data_pair_counter_map_t& pair_counts)
{
...
// find the most frequent pair
template <class PT>
void find_most_frequent_pos_neg_pair(PT pair_type, const Compiler_rule_data_list_t& rule_data_list,
                                     Compiler_node_data_pair& max_pair, int& max_count)
{
    Compiler_node_data_pair_counter_map_t pair_counts;
...
template <class PT>
void generate_pos_neg_pairs(PT pair_type, const Compiler_node_data_list_t& pos_node_data_list,
                            const Compiler_node_data_list_t& neg_node_data_list,
                            Compiler_node_data_pair_counter_map_t& pair_counts)
{
    for (Compiler_node_data_list_t::const_iterator it2 = pos_node_data_list.begin(); it2 != pos_node_data_list.end();
         it2++) {
        Compiler_node_data_pair new_pair;
        for (Compiler_node_data_list_t::const_iterator it3 = neg_node_data_list.begin();
             it3 != neg_node_data_list.end(); it3++) {
            if (pair_type.make_valid_pair((*it2), (*it3), new_pair)) {
                // new_pair.display();
                // PPS_out << endl;
