...
public:
    Binding_set_list()
    {
    } // default ctor to allow declaration of const empty object - dk 07/18/2012
...
public:
    ...
    */
    ...
    template <class MT>
    bool add_combination_if_match_source(MT match_type, const Binding_set_list& modification,
                                         const Binding_set_list& source, Binding_set_list& changes)
    {
    ...
    template <class MT>
    bool add_mod_if_match_source(MT match_type, const Binding_set_list& modification, const Binding_set_list& source,
                                 Binding_set_list& changes)
    {
        Binding_set_list_t::const_iterator mod_it;
        Binding_set_list_t::const_iterator source_it;
        Binding_set result;
    ...
    template <class MT>
    bool add_mod_if_not_match_source(MT match_type, const Binding_set_list& modification,
                                     const Binding_set_list& source, Binding_set_list& changes)
    {
        Binding_set_list_t::const_iterator mod_it;
        Binding_set_list_t::const_iterator source_it;
    ...
    template <class MT>
    bool remove_if_match(MT match_type, const Binding_set_list& modification, Binding_set_list& changes)
    {
        Binding_set_list_t::const_iterator mod_it;
