...
Need to be sure that *no* messages about an object get sent forward unless it is visible - cf your
come-into/go-outof-view modifications.
...
The device assigns a physical name to an object, and the Eye_processor assigns a psychological name when the object
appears for the first time, regardless of whether the object is in view or an eye movement is underway. The names are
used to establish object identity. Changes happening to an object with the same physical name are assumed to be
happening to the same corresponding psychological object.
...
The physical name is retained until the psychological name (and corresponding object) is discarded from visual
perceptual store, (which normally happens later), whereupon the physical name is discarded.
...
Changes in the physical store that happen during an eye movement have no effect during the eye movement; as appropriate,
the object information will be updated when the eye movement is complete.
...
public:
    ...
    {
        msg = proc_ptr->processor_info() + "Unknown physical property received: " + propname.str();
    }
};
...
void Eye_processor::setup()
{
    ...
    availabilities[Visible_c] = make_shared<Periphery_std_zone_availability>(physical_store, Visible_c);
    availabilities[Position_c] = make_shared<Relation_std_zone_availability>(physical_store, Position_c);
    availabilities[Vposition_c] = make_shared<Relation_std_zone_availability>(physical_store, Vposition_c);
    availabilities[Hposition_c] = make_shared<Relation_std_zone_availability>(physical_store, Hposition_c);
    availabilities[In_row_c] = make_shared<Relation_std_zone_availability>(physical_store, In_row_c);
    availabilities[In_col_c] = make_shared<Relation_std_zone_availability>(physical_store, In_col_c);
    availabilities[Orientation_c] = make_shared<Relation_std_zone_availability>(physical_store, Orientation_c);
    availabilities[Leader_c] = make_shared<Relation_std_zone_availability>(physical_store, Orientation_c);
    availabilities[Above_c] = make_shared<Relation_std_zone_availability>(physical_store, Above_c);
    availabilities[Below_c] = make_shared<Relation_std_zone_availability>(physical_store, Below_c);
    availabilities[Left_of_c] = make_shared<Relation_std_zone_availability>(physical_store, Left_of_c);
    availabilities[Right_of_c] = make_shared<Relation_std_zone_availability>(physical_store, Right_of_c);
    availabilities[Inside_c] = make_shared<Relation_std_zone_availability>(physical_store, Inside_c);
    availabilities[In_center_of_c] = make_shared<Relation_std_zone_availability>(physical_store, In_center_of_c);
    availabilities[Outside_c] = make_shared<Relation_std_zone_availability>(physical_store, Outside_c);
    availabilities[Placed_on_c] = make_shared<Relation_std_zone_availability>(physical_store, Placed_on_c);
    availabilities[Depth_c] = make_shared<Relation_std_zone_availability>(physical_store, Depth_c);
    availabilities[Distance_c] = make_shared<Relation_std_zone_availability>(physical_store, Distance_c);
    availabilities[Color_c] = make_shared<Color_std_zone_availability>(physical_store);
    availabilities[Targetable_c] = make_shared<Color_std_zone_availability>(physical_store);
    //	availabilities[Color_Vague_c] =
    //		make_shared<Color_std_zone_availability>(physical_store);
    availabilities[Shape_c] = make_shared<Shape_std_zone_availability>(physical_store);
    availabilities[Text_c] = make_shared<Text_std_zone_availability>(physical_store);
    //	availabilities[Size_c] =
    //		make_shared<Fovea_std_zone_availability>(physical_store, Size_c);
    availabilities[Encoded_size_c] = make_shared<Fovea_std_zone_availability>(physical_store, Encoded_size_c);
    default_availability = make_shared<Fovea_std_zone_availability>(physical_store, Default_c);

    // TSeymour: Char object availabilities for flanker task
    availabilities[Char_Line_Vert_c] = make_shared<Relation_std_zone_availability>(physical_store, Char_Line_Vert_c);
    availabilities[Char_Line_Horiz_c] = make_shared<Relation_std_zone_availability>(physical_store, Char_Line_Horiz_c);
    availabilities[Char_Line_Diag_c] = make_shared<Relation_std_zone_availability>(physical_store, Char_Line_Diag_c);
    availabilities[Char_Line_Smooth_c] =
        make_shared<Relation_std_zone_availability>(physical_store, Char_Line_Smooth_c);
    availabilities[Char_Point_Left_c] = make_shared<Relation_std_zone_availability>(physical_store, Char_Point_Left_c);
    availabilities[Char_Point_Right_c] =
        make_shared<Relation_std_zone_availability>(physical_store, Char_Point_Right_c);
    availabilities[Char_Curve_Open_c] = make_shared<Relation_std_zone_availability>(physical_store, Char_Curve_Open_c);
    ...
    attention_list[Position_c] = make_shared<Flat_attention>(physical_store, Position_c);
    attention_list[Vposition_c] = make_shared<Flat_attention>(physical_store, Vposition_c);
    attention_list[Hposition_c] = make_shared<Flat_attention>(physical_store, Hposition_c);
    attention_list[In_row_c] = make_shared<Flat_attention>(physical_store, In_row_c);
    attention_list[In_col_c] = make_shared<Flat_attention>(physical_store, In_col_c);
    attention_list[Orientation_c] = make_shared<Flat_attention>(physical_store, Orientation_c);
    attention_list[Leader_c] = make_shared<Flat_attention>(physical_store, Leader_c);
    attention_list[Above_c] = make_shared<Flat_attention>(physical_store, Above_c);
    attention_list[Below_c] = make_shared<Flat_attention>(physical_store, Below_c);
    attention_list[Left_of_c] = make_shared<Flat_attention>(physical_store, Left_of_c);
    attention_list[Right_of_c] = make_shared<Flat_attention>(physical_store, Right_of_c);
    attention_list[Inside_c] = make_shared<Flat_attention>(physical_store, Inside_c);
    attention_list[In_center_of_c] = make_shared<Flat_attention>(physical_store, In_center_of_c);
    attention_list[Outside_c] = make_shared<Flat_attention>(physical_store, Outside_c);
    attention_list[Placed_on_c] = make_shared<Flat_attention>(physical_store, Placed_on_c);
    attention_list[Depth_c] = make_shared<Flat_attention>(physical_store, Depth_c);
    attention_list[Distance_c] = make_shared<Flat_attention>(physical_store, Distance_c);
    attention_list[Color_c] = make_shared<Flat_attention>(physical_store, Color_c);
    attention_list[Targetable_c] = make_shared<Flat_attention>(physical_store, Targetable_c);
    attention_list[Shape_c] = make_shared<Flat_attention>(physical_store, Shape_c);
    attention_list[Text_c] = make_shared<Flat_attention>(physical_store, Text_c);
    attention_list[Encoded_size_c] = make_shared<Flat_attention>(physical_store, Encoded_size_c);
    default_attention = make_shared<Flat_attention>(physical_store, Default_c);

    // Flanker property attention entries
    attention_list[Char_Line_Vert_c] = make_shared<Flat_attention>(physical_store, Char_Line_Vert_c);
    attention_list[Char_Line_Horiz_c] = make_shared<Flat_attention>(physical_store, Char_Line_Horiz_c);
    attention_list[Char_Line_Diag_c] = make_shared<Flat_attention>(physical_store, Char_Line_Diag_c);
    attention_list[Char_Line_Smooth_c] = make_shared<Flat_attention>(physical_store, Char_Line_Smooth_c);
    attention_list[Char_Point_Left_c] = make_shared<Flat_attention>(physical_store, Char_Point_Left_c);
    attention_list[Char_Point_Right_c] = make_shared<Flat_attention>(physical_store, Char_Point_Right_c);
    attention_list[Char_Curve_Open_c] = make_shared<Flat_attention>(physical_store, Char_Curve_Open_c);
    attention_list[Char_Curve_Closed_c] = make_shared<Flat_attention>(physical_store, Char_Curve_Closed_c);
...
void Eye_processor::accept_event(const Stop_event*)
{
    ...
    //	Normal_out << "Eye_processor availability statistics: " << availability_accumulator.get_proportion() << ' ' <<
    // availability_accumulator.get_n() << endl; 	for(int i = 0; i < availability_distribution.get_n_bins(); i++) {
    //		Normal_out << i * availability_distribution.get_bin_size() << ' ' <<
    // availability_distribution.get_bin_proportion(i) << endl;
    //		}
}
...
void Eye_processor::make_object_appear(const Symbol& physical_name, GU::Point location, GU::Size size)
{
    ...
    shared_ptr<Visual_store_object> obj_ptr =
        get_human_ptr()->get_Visual_physical_store_ptr()->get_object_ptr(physical_name);
    ...
    if (new_visibility) {
        if (get_trace() && Trace_out)
            Trace_out << processor_info() << " object " << physical_name << '/' << psychological_name
                      << " has appeared while eye stationary" << endl;
        long appearance_time = get_time() + appearance_disappearance_delay.get_long_value();
        schedule_event(new Visual_Appear_event(appearance_time, get_human_ptr()->get_visual_sensory_store_ptr(),
                                               psychological_name, location_noise(obj_ptr->get_location()),
                                               obj_ptr->get_size()));
        /*
                // send onset event
    ...
    if (reflex_enabled && reflex_on && free_to_move()) {
        ...
        last_invol_ocular_command_time =
            get_time() + appearance_disappearance_delay.get_long_value() + inform_invol_ocular_delay.get_long_value();
...
void Eye_processor::handle_event(const Visual_Disappear_event* event_ptr)
{
    ...
    schedule_event(new Visual_Disappear_event(get_time() + appearance_disappearance_delay.get_long_value(),
                                              get_human_ptr()->get_visual_sensory_store_ptr(), event_ptr->object_name));
}
...
{
    // if the object went out of view a long time ago, it will be unknown to the system that it is disappearing, so do
    // nothing if the object is not known.
    ...
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "make object " << physical_name << '/' << psychological_name << " disappear"
                  << endl;
    ...
    // leave physical name in the map - it may be needed if e.g. an eye movement is made to an object that is
    // disappearing - dk 2/2/09
    /* // here we set the physical_name to Disappeared_object_c to show that the physical object is actually not there
    any more name_map.replace_physical_name_for_psychological_name(Disappeared_object_c, psychological_name);
    */
    ...
    if (voluntary_saccade_underway || involuntary_saccade_underway) {
        ...
        schedule_event(new Visual_Disappear_event(disappearance_time, get_human_ptr()->get_visual_sensory_store_ptr(),
                                                  psychological_name));
        /*
                // send offset event
                schedule_event(new Visual_Change_Property_event(
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "set object " << physical_name << " location to " << location << endl;
    ...
    if (voluntary_saccade_underway || involuntary_saccade_underway) {
        ...
        if (get_trace() && Trace_out) {
            Trace_out << processor_info() << "saccadic suppression: defer set object " << physical_name
                      << " location to " << location << " until " << rescheduled_time << endl;
        }
        schedule_event(new Visual_Change_Location_event(rescheduled_time, this, physical_name, location));
        return;
    }
    // access the object
    shared_ptr<Visual_store_object> obj_ptr =
    ...
    const Symbol& psychological_name = name_map.get_psychological_name(physical_name);
    schedule_event(new Visual_Change_Location_event(get_time() + location_delay.get_long_value(),
                                                    get_human_ptr()->get_visual_sensory_store_ptr(), psychological_name,
                                                    location));
    ...
    if (reflex_enabled && reflex_on && !centering_active && free_to_move()) {
        ...
        shared_ptr<Motor_action> action_ptr(new Invol_ocular_Saccade_action(get_human_ptr(), psychological_name));
        last_invol_ocular_command_time =
            get_time() + location_delay.get_long_value() + inform_invol_ocular_delay.get_long_value();
        action_ptr->dispatch(last_invol_ocular_command_time);
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "set object " << physical_name << " size to " << size << endl;
    if (!(get_human_ptr()->get_Visual_physical_store_ptr()->is_present(physical_name))) {
        if (get_trace() && Trace_out)
    ...
    if (voluntary_saccade_underway || involuntary_saccade_underway) {
        ...
        long rescheduled_time = eye_movement_complete_time + 1;
        if (get_trace() && Trace_out) {
            Trace_out << processor_info() << "saccadic suppression: defer set object " << physical_name << " size to "
                      << size << " until " << rescheduled_time << endl;
        }
    ...
    if (visible) {
        ...
        schedule_event(new Visual_Change_Size_event(get_time() + size_delay.get_long_value(),
                                                    get_human_ptr()->get_visual_sensory_store_ptr(), psychological_name,
                                                    size));
        update_all_properties(obj_ptr);
    }
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "set object " << physical_name << " property " << prop_name << " to "
                  << prop_value << endl;
    ...
    if (voluntary_saccade_underway || involuntary_saccade_underway) {
        ...
        long rescheduled_time = eye_movement_complete_time + 1;
        if (get_trace() && Trace_out) {
            Trace_out << processor_info() << "saccadic suppression: defer set object " << physical_name << " property "
                      << prop_name << " to " << prop_value << " until " << rescheduled_time << endl;
        }
        schedule_event(new Visual_Change_Property_event(rescheduled_time, this, physical_name, prop_name, prop_value));
        return;
    }
    ...
    //		Normal_out << "from apply_availability: " << obj_ptr->get_name() << ' ' << available << ' ' << new_value <<
    // endl;
    ...
    if (it_attention != attention_list.end()) {
        ...
        if (atten_delay > 0) {
            delay = atten_delay;
            // std::cout << prop_name << " ECC:" << obj_ptr->get_eccentricity() << " DELAY:" << delay << " ATTN_COEFF:"
            // << attention_coeff << "\n"; //DEBUG output
        }
    }
    ...
    schedule_event(new Visual_Change_Property_event(get_time() + delay, get_human_ptr()->get_visual_sensory_store_ptr(),
                                                    name_map.get_psychological_name(physical_name), prop_name,
                                                    new_value));
}
...
bool Eye_processor::apply_availability(shared_ptr<Visual_store_object> obj_ptr, Symbol prop_name, Symbol& prop_value,
                                       long& delay)
{
    ...
    */
    ...
    //	if(prop_name == Color_c)
    //		Normal_out << "Color apply_availability result for " << obj_ptr->get_name() << ' ' << available << " as " <<
    // prop_value << endl;
    return available;
}
...
bool Eye_processor::update_location_information(shared_ptr<Visual_store_object> obj_ptr)
{
    ...
    if (new_visibility) {
        if (!old_visibility) { // came into view or appeared
            if (get_trace() && Trace_out)
                Trace_out << processor_info() << ((new_object) ? " new" : " reinstated") << " object " << physical_name
                          << '/' << psychological_name << " has come into view" << endl;
            // the physical name is now in use for an object that is present
            name_map.set_physical_name_in_use(physical_name, true);
            long appearance_delay_time = appearance_disappearance_delay.get_long_value();
            schedule_event(new Visual_Appear_event(get_time() + appearance_delay_time,
                                                   get_human_ptr()->get_visual_sensory_store_ptr(), psychological_name,
                                                   location_noise(obj_ptr->get_location()), obj_ptr->get_size()));
        }
    ...
    //	else if(old_visibility || old_was_visible) {
        ...
        if (get_trace() && Trace_out)
            Trace_out << processor_info() << " object " << physical_name << '/' << psychological_name
                      << " has gone out of view" << endl;
        // the physical name is now longer in use because the object isn't visually present any more
        name_map.set_physical_name_in_use(physical_name, false);
...
void Eye_processor::send_eccentricity_update(const Symbol& psychological_name, double ecc)
{
    ...
    const Symbol& eccentricity_zone_value = (ecc <= standard_fovea_radius) ? Fovea_c : Periphery_c;
    schedule_event(new Visual_Change_Property_event(get_time() + eccentricity_delay.get_long_value(),
                                                    get_human_ptr()->get_visual_sensory_store_ptr(), psychological_name,
                                                    Eccentricity_c, eccentricity_value));
    schedule_event(new Visual_Change_Property_event(get_time() + eccentricity_delay.get_long_value(),
                                                    get_human_ptr()->get_visual_sensory_store_ptr(), psychological_name,
                                                    Eccentricity_zone_c, eccentricity_zone_value));
}
...
*/
void Eye_processor::send_property_availability_update(shared_ptr<Visual_store_object> obj_ptr, const Symbol& prop_name,
                                                      const Symbol& prop_value)
{
    ...
    // go ahead and send the property forward
    schedule_event(new Visual_Change_Property_event(get_time() + delay, get_human_ptr()->get_visual_sensory_store_ptr(),
                                                    psychological_name, prop_name, new_value));
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Availability change for object " << psychological_name << " property "
                  << prop_name << " to " << new_value << endl;
}
...
Symbol Eye_processor::change_related_object_name(const Symbol& prop_name, const Symbol& prop_value)
{
    ...
    if (prop_value == Nil_c)
        return new_value;
    if (prop_name == Left_of_c || prop_name == Right_of_c || prop_name == Above_c || prop_name == Below_c ||
        prop_name == Inside_c || prop_name == In_center_of_c || prop_name == Outside_c || prop_name == In_row_c ||
        prop_name == In_col_c || prop_name == Placed_on_c) {
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Voluntary_Saccade_Start to " << event_ptr->new_eye_location << endl;
    voluntary_saccade_underway = true;
    // if we are doing a voluntary movement, we can't possibly be doing an involuntary one - it might have gotten
    // cancelled!
    //	involuntary_movement_in_progress = false;
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Voluntary_Saccade_End to" << future_eye_location << endl;
    voluntary_saccade_underway = false;
    eye_movement_complete_time = 0;
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Involuntary_Saccade_Start to " << event_ptr->new_eye_location << endl;
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Involuntary_Saccade_End to" << future_eye_location << endl;
    involuntary_saccade_underway = false;
    //	involuntary_movement_in_progress = false;
    eye_movement_complete_time = 0;
    eye_location = future_eye_location;
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Involuntary_Smooth_Move_Start to " << event_ptr->new_eye_location << endl;
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "Involuntary_Smooth_Move_End to" << future_eye_location << endl;
    involuntary_smooth_move_underway = false;
    //	involuntary_movement_in_progress = false;
    eye_movement_complete_time = 0;
    eye_location = future_eye_location;
...
void Eye_processor::update_all_object_location_information()
{
    ...
    for (Visual_store::Store_object_ptr_list_t::const_iterator it = object_ptrs.begin(); it != object_ptrs.end();
         ++it) {
...
{
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "perform_centering mode " << centering_enabled << ' ' << centering_on << ' '
                  << free_to_move() << endl;
    // if we are not centering, and the eye is busy, don't go any further
    if (!(centering_enabled && centering_on) || !free_to_move())
        return;
    if (get_trace() && Trace_out)
        Trace_out << processor_info() << "perform_centering checks " << closest_eccentricity << ' '
                  << bouquet_radius.get_double_value() << ' ' << centering_smooth_move_radius.get_double_value() << ' '
                  << centering_saccade_radius.get_double_value() << endl;
    if (closest_eccentricity < bouquet_radius.get_double_value())
        ...
        //		involuntary_movement_in_progress = true; // this gets reset for either a voluntary or involuntary
        // movement
        ...
        action_ptr->dispatch(last_invol_ocular_command_time);
        if (get_trace() && Trace_out)
            Trace_out << processor_info() << "Invol_ocular_Saccade_action commanded for "
                      << last_invol_ocular_command_time << endl;
    }
    else {
...
// this function returns true if it makes sense to command an involuntary eye movement - that is, any type of movement
// is neither underway nor be preparing; the situation will simply be changing too soon
