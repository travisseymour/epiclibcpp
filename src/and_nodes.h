...
public:
    ...
    virtual bool positive_update(const Combining_Node* source_node)
    {
        ...
        bool changed = binding_sets.add_combination_if_match_source(
            pos_match_type, source_node->get_delta_binding_sets(), other_node->get_binding_sets(), delta_binding_sets);
    ...
    virtual bool negative_update(const Combining_Node* source_node)
    {
        ...
        bool changed =
            binding_sets.remove_if_match(neg_match_type, source_node->get_delta_binding_sets(), delta_binding_sets);
        // if binding sets didn't change, nothing further to do.
        if (!changed)
            return false;
