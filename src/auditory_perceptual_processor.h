...
public:
    Auditory_perceptual_processor(Human_processor* human_ptr_)
        ...
        //		property_time_fluctuation("Property_delay_fluctuation_factor", Parameter::Normal, Parameter::Never, 1.0,
        //.5),
        ...
        , recoding_failure_rate1("Recoding_failure_rate1", 0.5)
        , // Custom failure rate #1
        ...
        , stream_loudness_weight("Stream_loudness_weight", 0.20)
        , // formerly 1-stream_lambda
        stream_pitch_weight("Stream_pitch_weight", 0.80)
        , // formerly stream_lambda
    ...
    */
    ...
    virtual void create_stream(const Symbol& stream_name, double pitch, double loudness,
                               GU::Point location); // not in base class!
    ...
    //	virtual void make_sound_event(const Symbol& sound_name, const Symbol& stream_name, const Symbol& timbre, double
    // loudness, long duration, long intrinsic_duration = 0); 	virtual void make_speech_sound_event(const Symbol&
    // sound_name, const Symbol& stream_name, const Symbol& utterance, double loudness, long duration); 	virtual void
    // erase_sound(const Symbol& sound_name);
...
private:
    ...
    virtual void make_new_sound_start_f(const Symbol& sound_name, const Symbol& stream_name, long time_stamp,
                                        GU::Point location, const Symbol& timbre, double loudness,
                                        long intrinsic_duration);
