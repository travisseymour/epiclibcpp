...
public:
    Line_segment()
        : // default is all values zero - normally not used.
        dx(0.)
        , dy(0.)
        , c(0.)
        , len(0.)
...
//     m.doc() = "EPICLib.Geometry bindings for Python 3.11";
//
//     m.def("to_radians", &Geometry_Utilities::to_radians, py::arg("theta_d"));
//     m.def("to_degrees", &Geometry_Utilities::to_radians, py::arg("theta_r"));
//
//     py::class_<Geometry_Utilities::Size>(m, "Size")
