...
public:
    Temporal_processor(Human_processor* human_ptr)
        ...
        ,
        // Removed "0.0, Parameter::Fixed" from the end of the three arguement lists below after DK's Parameter.cpp fix
        // in 2008.
        initial_time_increment("Initial_time_increment", 100)
        , // the "T sub zero" parameter
        increment_multiplier("Increment_multiplier", 1.02)
        ,                                           // the "a" parameter
