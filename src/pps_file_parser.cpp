...
bool PPS_file_parser::parse_file(Compiler_rule_data_list_t& production_list, Clause_list_t& initial_memory_contents,
                                 map<Symbol, Geometry_Utilities::Point>& named_locations,
...
void PPS_file_parser::parse_initial_memory_contents(Clause_list_t& initial_memory_contents,
...
void PPS_file_parser::parse_named_location(std::map<Symbol, Geometry_Utilities::Point>& named_locations,
                                           bool output_compiler_messages)
{
