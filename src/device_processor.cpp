...
void Device_processor::accept_event(const Start_event *)
{
	Assert(device_interface_ptr);
	if(Trace_out && get_trace())
		Trace_out << processor_info() << " Asking Device to call its handle_Start_event() method" << "(" << typeid(device_interface_ptr).name() << ")" << endl;
...
void Device_processor::accept_event(const Stop_event *)
{
	Assert(device_interface_ptr);
	if(Trace_out && get_trace())
		Trace_out << processor_info() << " Asking Device to call its handle_Stop_event() method" << "(" << typeid(device_interface_ptr).name() << ")" << endl;
