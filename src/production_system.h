...
public:
    Production_System()
        : output_compiler_messages(false)
        , output_compiler_details(false)
        , output_run_messages(false)
        , output_run_details(false)
        , output_run_memory_contents(false)
        , break_enabled(false)
        , fault_enabled(false)
        , cycle_counter(0)
    ...
    bool get_break_on_this_cycle() const
    {
        return break_on_this_cycle;
    }
