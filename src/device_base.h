...
public:
    ...
    virtual void handle_Delay_event(const Symbol& type, const Symbol& datum, const Symbol& object_name,
    ...
    virtual void handle_Ply_event(const Symbol& cursor_name, const Symbol& target_name, GU::Point new_location,
    ...
    void set_visual_object_property(const Symbol& object_name, const Symbol& property_name,
    ...
    */
    ...
    void make_auditory_sound_event(const Symbol& name, const Symbol& stream, GU::Point location, const Symbol& timbre,
    ...
    void make_auditory_sound_start(const Symbol& name, const Symbol& stream, GU::Point location, const Symbol& timbre,
    ...
    //	speaker_gender, speaker_id - surrogates/finesse of e.g. formant structure that distinguishes one speaker from
    // another 	loudness - in db - can be a cue to stream identification 	duration - of this speech object 	void
    // make_auditory_speech_event(const Symbol& sound_name, const Symbol& stream_name, 		const Symbol& content, const
    // Symbol& speaker_gender, const Symbol& speaker_id, double loudness, long duration);
    ...
    void make_high_level_input_appear(const Symbol& object_name, const Symbol_list_t& props,
    ...
    void schedule_delay_event(long delay, const Symbol& delay_type, const Symbol& object_name,
                              const Symbol& property_name, const Symbol& property_value);
    ...
    // TSeymour2020 - can't use ostream << "something" from python, so needed this
