...
{
public:
    Auditory_Stream_Set_Property_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Auditory_event(t, r)
        , stream_name(nm)
        , property_name(pn)
        , property_value(pv)
...
{
public:
    Auditory_Stream_Erase_Property_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Auditory_event(t, r)
        , stream_name(nm)
        , property_name(pn)
        , property_value(pv)
...
public:
    Auditory_Sound_Start_event(
        long t, Processor* r, const Symbol& nm,
...
{
public:
    Auditory_Sound_Set_Property_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Auditory_event(t, r)
        , sound_name(nm)
        , property_name(pn)
        , property_value(pv)
...
{
public:
    Auditory_Sound_Erase_Property_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Auditory_event(t, r)
        , sound_name(nm)
        , property_name(pn)
        , property_value(pv)
...
{
public:
    /*	Auditory_Speech_event(long t, Processor * r, const Symbol& sound_name_, const Symbol& stream_, const Symbol&
       content_, const Symbol& speaker_gender_, const Symbol& speaker_id_, double loudness_, long duration_) :
...
{
public:
    Auditory_Delay_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Auditory_event(t, r)
        , object_name(nm)
        , property_name(pn)
        , property_value(pv)
