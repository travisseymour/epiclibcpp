...
public:
    ...
    */
    ...
    // sound inputs
    // physical interface
    virtual void make_sound_start(const Symbol& name, const Symbol& stream_name, GU::Point location,
    ...
    virtual void make_sound_event(const Symbol& name, const Symbol& stream_name, GU::Point location,
