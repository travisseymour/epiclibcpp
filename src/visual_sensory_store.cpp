...
void Visual_sensory_store::handle_event(const Visual_Appear_event* event_ptr)
{
    ...
    get_human_ptr()->get_Visual_perceptual_processor_ptr()->make_object_appear(event_ptr->name, event_ptr->location,
                                                                               event_ptr->size);
}
...
void Visual_sensory_store::handle_event(const Visual_Change_Location_event* event_ptr)
{
    ...
    if (changed)
        get_human_ptr()->get_Visual_perceptual_processor_ptr()->set_object_location(event_ptr->object_name,
                                                                                    event_ptr->location);
}
...
void Visual_sensory_store::handle_event(const Visual_Change_Size_event* event_ptr)
{
    ...
    if (changed)
        get_human_ptr()->get_Visual_perceptual_processor_ptr()->set_object_size(event_ptr->object_name,
                                                                                event_ptr->size);
}
...
void Visual_sensory_store::handle_event(const Visual_Change_Property_event* event_ptr)
{
    ...
    if (changed)
        get_human_ptr()->get_Visual_perceptual_processor_ptr()->set_object_property(
