...
public:
    Visual_perceptual_processor(Human_processor* human_ptr_)
        ...
        //		text_partial_recoding_rate("Text_partial_recoding_rate", 0.0),	// text is encoded with prefix of
        // Partial_
        recoding_failure_rate1("Recoding_failure_rate1", 0.0)
        , // Custom failure rate #1
        recoding_failure_rate2("Recoding_failure_rate2", 0.0)
        , // Custom failure rate #2
        recoding_failure_rate3("Recoding_failure_rate3", 0.0)
        , // Custom failure rate #3
        recoding_failure_rate4("Recoding_failure_rate4", 0.0)
        , // Custom failure rate #4
