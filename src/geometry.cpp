...
{
    os << "Cartesian_vector<" << cv.delta_x << ", " << cv.delta_y << '>';
    return os;
}
...
bool compute_center_intersecting_line(const Line_segment& start_to_center, const Size rect_size,
                                      Line_segment& clipped_line)
{
    // the start of the line is p0, the starting point, and will get moved to points of intersection during the
    // computation
