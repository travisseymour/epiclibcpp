...
public:
    Epic_exception()
        : Exception("Unspecified Epic_exception")
    {
    }
    Epic_exception(const std::string& msg_)
        : Exception(msg_)
    {
    }
...
public:
    Epic_internal_error()
        : Epic_exception("Unspecified Epic_internal_error")
    {
    }
    Epic_internal_error(const std::string& msg_)
        : Epic_exception(msg_)
    {
    }
