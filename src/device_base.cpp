...
void Device_base::handle_Delay_event(const Symbol& type, const Symbol& datum, const Symbol& object_name,
...
void Device_base::handle_Ply_event(const Symbol& cursor_name, const Symbol& target_name, GU::Point new_location,
...
void Device_base::make_visual_object_appear(const Symbol& object_name, Geometry_Utilities::Point location,
...
void Device_base::set_visual_object_property(const Symbol& object_name, const Symbol& property_name,
...
{
    device_proc_ptr->make_auditory_speech_event(sound_name, stream_name, content, speaker_gender, speaker_id, loudness,
duration);
}
*/
...
void Device_base::make_high_level_input_appear(const Symbol& object_name, const Symbol_list_t& props,
...
void Device_base::schedule_delay_event(long delay, const Symbol& delay_type, const Symbol& object_name,
                                       const Symbol& property_name, const Symbol& property_value)
{
...
void Device_base::set_human_parameter(const std::string& proc_name, const std::string& param_name,
...
// way to get string into device_out without relying on << operator
void Device_base::write(std::string msg)
{
    device_out << msg;
}