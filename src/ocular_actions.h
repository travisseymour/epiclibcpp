...
public:
    ...
    static std::shared_ptr<Motor_action> create(Human_processor* human_ptr, Symbol_list_t arguments,
...
public:
    ...
    Ocular_Move_action(Human_processor* human_ptr, const Symbol_list_t arguments, bool execute_when_prepared);
};
...
{
public:
    Ocular_Random_Move_action(Human_processor* human_ptr_, const Symbol_list_t& arguments, bool execute_when_prepared);
};
