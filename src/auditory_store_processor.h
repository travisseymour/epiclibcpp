...
public:
    ...
    */
    ...
    // sound inputs
    virtual void make_sound_start(const Symbol& sound_name, const Symbol& stream_name, const Symbol& timbre,
                                  double loudness, long intrinsic_duration);
    virtual void make_speech_start(const Symbol& sound_name, const Symbol& stream_name, const Symbol& timbre,
                                   const Symbol& content, const Symbol& speaker_gender, const Symbol& speaker_id,
                                   double loudness, long intrinsic_duration);
    virtual void make_sound_stop(const Symbol& sound_name);
    virtual void make_sound_event(const Symbol& sound_name, const Symbol& stream_name, const Symbol& timbre,
                                  double loudness, long duration, long intrinsic_duration = 0);
    virtual void make_speech_sound_event(const Symbol& sound_name, const Symbol& stream_name, const Symbol& utterance,
                                         double loudness, long duration);
