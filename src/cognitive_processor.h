...
public:
    Cognitive_processor(Human_processor* human_ptr_)
        ...
        , probability1("Probability1", 0.5)
        , probability2("Probability2", 0.5)
        , probability3("Probability3", 0.5)
        , probability4("Probability4", 0.5)
        , probability5("Probability5", 0.5)
        , command_interface(human_ptr_)
        , ready_to_run(false)
    {
    ...
    // Travis Seymour March 17 2023
    // Need a way to get access to the production system from pythin via pybind11
