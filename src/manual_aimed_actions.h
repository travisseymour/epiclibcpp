...
public:
    ...
    Manual_aimed_action(Human_processor* human_ptr_, const Symbol& cursor_, const Symbol& target_, const Symbol& hand_,
...
Cursor_name_c and right hand are assumed; an action is generated that defaults to 1.1 if target size or distance is
unknown or zero.
*/
