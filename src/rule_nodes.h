...
public:
    Rule_Node(Production_System* in_production_system_ptr, const Symbol& in_rule_name, Combining_Node* in_input,
              ...
              const list_Symbol_list_t& command_action_list, const list_Symbol_list_t& add_command_action_list,
              const list_Symbol_list_t& add_command_pattern_list)
        : production_system_ptr(in_production_system_ptr)
        , input(in_input)
        , rule_name(in_rule_name)
        , faulted_flag(false)
        , break_flag(false)
        , add_action_patterns(add_action_list)
        , delete_action_patterns(delete_action_list)
        , command_actions(command_action_list)
        , add_command_actions(add_command_action_list)
        , add_command_patterns(add_command_pattern_list)
    {
    }
    ...
    static Combining_Node* create(Production_System* production_system_ptr, const Symbol& rule_name,
    ...
    bool get_fault_state() const
    {
        return faulted_flag;
    }
    void set_fault_state(bool faulted_flag_)
    {
        faulted_flag = faulted_flag_;
    }
    bool get_break_state() const
    {
        return break_flag;
    }
    void set_break_state(bool break_flag_)
    {
...
{
public:
    Simple_Rule_Node(Production_System* in_production_system_ptr, int in_id, const Symbol& in_rule_name,
                     Combining_Node* in_input, const list_Symbol_list_t& add_action_list,
                     const list_Symbol_list_t& delete_action_list, const list_Symbol_list_t& command_action_list,
                     const list_Symbol_list_t& add_command_action_list,
                     const list_Symbol_list_t& add_command_pattern_list)
        : Combining_Node(in_id)
        , Rule_Node(in_production_system_ptr, in_rule_name, in_input, add_action_list, delete_action_list,
...
{
public:
    Bindings_Rule_Node(Production_System* in_production_system_ptr, int in_id, const Symbol& in_rule_name,
                       Combining_Node* in_input, const list_Symbol_list_t& add_action_list,
                       const list_Symbol_list_t& delete_action_list, const list_Symbol_list_t& command_action_list,
                       const list_Symbol_list_t& add_command_action_list,
                       const list_Symbol_list_t& add_command_pattern_list)
...
public:
    Bindings_Predicate_Rule_Node(Production_System* in_production_system_ptr, int in_id, const Symbol& in_rule_name,
                                 ...
                                 const list_Symbol_list_t& add_action_list,
                                 const list_Symbol_list_t& delete_action_list,
                                 const list_Symbol_list_t& command_action_list,
                                 const list_Symbol_list_t& add_command_action_list,
                                 const list_Symbol_list_t& add_command_pattern_list)
        : Bindings_Rule_Node(in_production_system_ptr, in_id, in_rule_name, in_input, add_action_list,
                             delete_action_list, command_action_list, add_command_action_list, add_command_pattern_list)
        , predicate_ptrs(in_predicate_ptrs)
    {
    }
