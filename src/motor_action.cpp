...
Motor_action_exception::Motor_action_exception(Human_processor* hum_ptr, string msg, const Symbol_list_t& arguments)
    : Epic_exception(hum_ptr, string("Invalid Motor action: ") + msg + "(" + concatenate_to_string(arguments) + ")")
{
}

Motor_action_exception::Motor_action_exception(Human_processor* hum_ptr, string msg, const Symbol& argument)
