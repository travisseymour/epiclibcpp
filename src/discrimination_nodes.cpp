...
Combining_Node* Discrimination_Node::build_pattern(const Clause& pattern, Variable_list& var_names,
                                                   bool wildcard_present, int wildcard_number)
{
    //	PPS_out << "build_pattern with " << pattern << ", " << var_names << ", " << wildcard_present << " and " <<
    // wildcard_number << endl;
