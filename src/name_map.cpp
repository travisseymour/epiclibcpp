...
public:
    ...
    {
        ostringstream oss;
        oss << "Attempt to store physical name" << physical_name << " in name map, but it is already present";
        msg = oss.str();
    }
};
...
public:
    ...
    {
        ostringstream oss;
        oss << "Attempt to store psychological name" << psychological_name << " in name map, but it is already present";
        msg = oss.str();
    }
};
...
public:
    ...
    {
        ostringstream oss;
        oss << "Attempt to store " << physical_name << '/' << psychological_name
...
public:
    ...
    {
        ostringstream oss;
        oss << "Attempt to access name map using unknown name: " << obj_name;
        msg = oss.str();
    }
};
...
public:
    ...
    {
        ostringstream oss;
        oss << "Attempt to access name map name in use using unknown name: " << obj_name;
        msg = oss.str();
    }
};
...
void Name_map::replace_physical_name_for_psychological_name(const Symbol& physical_name,
                                                            const Symbol& psychological_name)
{
