...
{
public:
    Cognitive_Cycle_event(long t, Processor* r)
        : Cognitive_event(t, r)
    {
    }
...
{
public:
    Cognitive_Update_event(long t, Processor* d, const Symbol& tag_name_, const Symbol& object_name_,
                           const Symbol& property_name_, const Symbol& old_value_, const Symbol& new_value_)
        : Cognitive_event(t, d)
        , tag_name(tag_name_)
...
private:
    Cognitive_Visual_Update_event(long t, Processor * r,
        ...
        Cognitive_event(t, r), object_name(object_name_), property_name(property_name_), old_value(old_value_),
new_value(new_value_)
        {}
};
