...
template bool Binding_set_list::add_if_match_source<Combine_full_overlap_binding_sets>
(Combine_full_overlap_binding_sets); template bool
Binding_set_list::add_if_match_source<Combine_partial_overlap_binding_sets> (Combine_partial_overlap_binding_sets);
template bool Binding_set_list::add_if_match_source<Combine_no_overlap_binding_sets> (Combine_no_overlap_binding_sets);

template bool Binding_set_list::add_if_not_match_source<Combine_full_overlap_binding_sets>
(Combine_full_overlap_binding_sets); template bool
Binding_set_list::add_if_not_match_source<Combine_partial_overlap_binding_sets> (Combine_partial_overlap_binding_sets);
template bool Binding_set_list::add_if_not_match_source<Combine_no_overlap_binding_sets>
(Combine_no_overlap_binding_sets);

template bool Binding_set_list::remove_if_match<Combine_full_overlap_binding_sets> (Combine_full_overlap_binding_sets);
template bool Binding_set_list::remove_if_match<Combine_partial_overlap_binding_sets>
(Combine_partial_overlap_binding_sets); template bool Binding_set_list::remove_if_match<Combine_no_overlap_binding_sets>
(Combine_no_overlap_binding_sets);
*/
