...
// physical interface
void Auditory_processor::make_sound_start(const Symbol&, const Symbol&, const Symbol&, double, long)
{
    Assert(!"make_sound_start called on wrong kind of object");
}
void Auditory_processor::make_sound_event(const Symbol&, const Symbol&, const Symbol&, double, long, long)
{
...
void Auditory_processor::make_new_sound_start(const Symbol&, const Symbol&, long, const Symbol&, double, long)
{
...
{
    Assert(!"set_sound_property called on wrong kind of object");
    return Symbol();
}