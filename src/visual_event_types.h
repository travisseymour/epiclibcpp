...
{
public:
    Visual_Change_Property_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Visual_event(t, r)
        , object_name(nm)
        , property_name(pn)
        , property_value(pv)
...
{
public:
    Visual_Erase_Property_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Visual_event(t, r)
        , object_name(nm)
        , property_name(pn)
        , property_value(pv)
...
{
public:
    Visual_Delay_event(long t, Processor* r, const Symbol& nm, const Symbol& pn, const Symbol& pv)
        : Visual_event(t, r)
        , object_name(nm)
        , property_name(pn)
        , property_value(pv)
