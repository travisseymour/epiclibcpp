...
public:
    ...
    virtual void clear()
    {
        throw Epic_exception("You Must Override View_base.clear(). View_base is usually abstract but was made "
                             "non-abstract for easier access via Python.");
    }
    ...
    //	virtual void notify_auditory_speech_start(const Symbol&, const Symbol&, long, const Symbol&, const Symbol&,
    // const Symbol&, double)
    //		{}
