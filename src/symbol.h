...
{
public:
    Symbol_exception(const char* in_msg)
        : Exception(in_msg)
    {
    }
};
...
public:
    ...
    {
        return this->get_numeric_value();
    }

    GU::Point get_point() const
    {
        return this->get_Point();
    }

    std::vector<GU::Point> get_points() const
    {
        return this->get_Point_vector();
    }
    ...
    bool has_num() const
    {
        return this->has_numeric_value();
    }

    bool has_single_num() const
    {
        return this->has_single_numeric_value();
    }

    bool has_point_num() const
    {
        return this->has_Point_numeric_value();
    }

    bool has_pair_num() const
    {
        return this->has_pair_numeric_value();
    }

    bool has_multi_num() const
    {
        return this->has_multiple_numeric_value();
    }

    void swap(PySymbol& other)
    {
        this->Symbol::swap(other);
    }
};
