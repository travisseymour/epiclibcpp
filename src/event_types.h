...
{
public:
    Start_event(long t, Processor* d)
        : Event(t, d)
    {
    }
...
protected:
    Visual_event(long t, Processor* d)
        : Event(t, d)
    {
    }
};
...
protected:
    Auditory_event(long t, Processor* d)
        : Event(t, d)
    {
    }
};
...
protected:
    Cognitive_event(long t, Processor* d)
        : Event(t, d)
    {
    }
};
...
protected:
    Motor_event(long t, Processor* d)
        : Event(t, d)
    {
    }
};
...
{
public:
    Temporal_event(long t, Processor* d)
        : Event(t, d)
    {
    }
    virtual void send_self(Processor*) const;
...
protected:
    Device_event(long t, Processor* d)
        : Event(t, d)
    {
    }
};
