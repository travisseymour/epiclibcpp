...
{
protected:
    Device_Input_event(long t, Processor* d)
        : Device_event(t, d)
    {
    }
};
...
{
protected:
    Device_Output_event(long t, Processor* d)
        : Device_event(t, d)
    {
    }
};
...
public:
    ...
    Device_Delay_event(long t, Processor* d, const Symbol& tp, const Symbol& on, const Symbol& pn, const Symbol& pv)
        : Device_event(t, d)
        , type(tp)
        , object_name(on)
        , property_name(pn)
...
{
public:
    Device_Ply_event(long t, Processor* d, const Symbol& cursor_name_, const Symbol& target_name_,
                     GU::Point new_location_, GU::Polar_vector movement_vector_)
        : Device_Input_event(t, d)
        , cursor_name(cursor_name_)
        , target_name(target_name_)
        , new_location(new_location_)
        , movement_vector(movement_vector_)
    {
    }
    virtual void handle_self(Device_processor*) const;
    Symbol cursor_name;
...
{
public:
    Device_Eyemovement_Start_event(long t, Processor* d, const Symbol& target_name_, GU::Point new_location_)
        : Device_Input_event(t, d)
        , target_name(target_name_)
        , new_location(new_location_)
    {
...
{
public:
    Device_Eyemovement_End_event(long t, Processor* d, const Symbol& target_name_, GU::Point new_location_)
        : Device_Input_event(t, d)
        , target_name(target_name_)
        , new_location(new_location_)
    {
...
{
public:
    Device_HLGet_event(long t, Processor* r, const Symbol_list_t& ps, const Symbol_list_t& vs, const Symbol& tg)
        : Device_Input_event(t, r)
        , props(ps)
        , values(vs)
        , tag(tg)
...
{
public:
    Device_HLPut_event(long t, Processor* r, const Symbol_list_t& ps, const Symbol_list_t& vs)
        : Device_Input_event(t, r)
        , props(ps)
        , values(vs)
    {
