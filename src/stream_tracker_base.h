...
public:
    ...
    // call for first word set to create the streams, one for each currently present sound, using specified stream_type,
    // and simply assigning in order
...
protected:
    ...
    } // for use in Stream_type_factory;
