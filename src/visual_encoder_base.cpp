...
void Visual_encoder_base::schedule_change_property_event(long recoding_time, const Symbol& obj_name,
...
void Visual_encoder_base::schedule_delayed_delivery_event(long delay_time, const Symbol& object_name,
                                                          const Symbol& property_name, const Symbol& property_value)
{
    ...
    perceptual_proc_ptr->schedule_event(
        new Visual_Delay_event(event_time, perceptual_proc_ptr, object_name, property_name, property_value));
}
...
void Visual_encoder_base::schedule_delay_event(long delay, const Symbol& object_name, const Symbol& property_name,
                                               const Symbol& property_value)
{
    ...
    Event* output_event_ptr =
        new Visual_Delay_event(get_time() + delay, perceptual_proc_ptr, object_name, property_name, property_value);
