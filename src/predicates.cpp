...
Unary_predicate::Unary_predicate(const Symbol& in_argument)
    ...
    , arg_is_variable(is_variable(in_argument))
{
}
...
Binary_predicate::Binary_predicate(const Symbol& in_argument1, const Symbol& in_argument2)
    : argument1(in_argument1)
    , is_variable1(is_variable(argument1))
    , argument2(in_argument2)
    , is_variable2(is_variable(argument2))
{
}
